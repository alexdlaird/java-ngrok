...
- `obj` parsing
  in [`NgrokLog`](https://javadoc.io/static/com.github.alexdlaird/java8-ngrok/1.4.14/com/github/alexdlaird/ngrok/process/NgrokLog.html).
- `throws` for unchecked exceptions to documentation.
- Documentation improvements.
- Build and stability improvements.
...
- Minor bugs, including a typo in the name
  of [JavaNgrokConfig.getStartupTimeout()](https://javadoc.io/static/com.github.alexdlaird/java8-ngrok/1.4.14/com/github/alexdlaird/ngrok/conf/JavaNgrokConfig.html#getStartupTimeout--).
